...
- 当前状态：`T4017e -> T4017f -> T4017R -> T4012b3 -> T4012c -> T4012R -> T4013 -> T4013R`。
...
- 当前状态：`T4017a`、`T4017b`、`T4017c` 与 `T4017d` 已完成；下一步执行 `T4017e`，之后继续 `T4017f -> T4017R -> T4012b3 -> T4012c -> T4012R -> T4013 -> T4013R`。
