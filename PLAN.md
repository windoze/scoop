...
- 当前状态：`T4017R -> T4012b3 -> T4012c -> T4012R -> T4013 -> T4013R`。
...
- 当前状态：`T4017a`、`T4017b`、`T4017c`、`T4017d`、`T4017e1`、`T4017e2`、`T4017e3` 与 `T4017f` 已完成，`T4017e` 已整体收口。下一步执行 `T4017R`，之后继续 `T4012b3 -> T4012c -> T4012R -> T4013 -> T4013R`。
