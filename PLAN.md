...
- 当前顺序已进一步细化为：`T3010b2b1a`（已完成：direct 路径）→ `T3010b2b1b0`（synthetic resume slot id / frame seeding）→ `T3010b2b1b`（unified value coercion / expected-context）→ `T3010b2b1`（剩余 nested/indirect outward propagation 验收）。
