...
| B-08 | MIR 成员存取 / 赋值合法性 | B | 6 | FrontendReject=2; InternalBugSentinel=4 | pass MIR member store target not writable (1)<br>pass MIR member store value type (1)<br>pass MIR member store operand type (1)<br>pass MIR immutable class member store (1)<br>pass MIR member store receiver place (1) | crates/scoopc/src/llvm/codegen/mir_body/member.rs (6) | CSV non-empty; body pending U2-T02. |
...
| B-21 | Struct literal / 字段层 | B | 6 | FrontendReject=3; InternalBugSentinel=3 | unknown struct field (1)<br>struct literal missing field (1)<br>struct field value (1)<br>pass MIR struct literal missing field (1)<br>pass MIR class member field index (1) | crates/scoopc/src/llvm/codegen/main/expr_value.rs (2)<br>crates/scoopc/src/llvm/codegen/layout.rs (1)<br>crates/scoopc/src/llvm/codegen/mir_body/aggregates.rs (1)<br>crates/scoopc/src/llvm/codegen/mir_body/member.rs (1)<br>crates/scoopc/src/llvm/codegen/ty.rs (1) | CSV non-empty; body pending U2-T02. |
