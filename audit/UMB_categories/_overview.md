...
| B-24 | Reflection / static metadata intrinsic | C/D | 0 | retired RealImpl=6 | retired: sizeOf() arity mismatch (1)<br>sizeOf() arg type (1)<br>reflection intrinsic call binding (1)<br>pass MIR sizeOf arg type (1)<br>pass MIR kindOf arg type (1) | retired ledger: `audit/UMB_retired.csv` | P7-C1 retired reflection/static-metadata intrinsic rows. |
