...
- Total active inventory entries: 159
- Bucket range: B-01 through B-36
- Zero-entry buckets: B-01, B-02, B-03, B-04, B-05, B-06, B-07, B-08, B-09, B-11, B-13, B-14, B-15, B-16, B-17, B-18, B-19, B-20, B-21, B-22, B-23, B-24, B-25, B-26, B-27, B-28, B-29, B-30, B-31, B-32, B-33, B-34, B-35, B-36
...
| B-29 | GC intrinsic 系列 | B | 0 | retired InternalBugSentinel=93 | retired: GC.pin arg value (2)<br>GC.pin return type (2)<br>GC.pin field value (2)<br>GC.unpin arg type (2)<br>GC.unpin arg value (2) | retired ledger: `audit/UMB_retired.csv` | P7-B3.4 retired GC intrinsic contract rows. |
| B-30 | named / unsafe / FunPtr intrinsic | B | 0 | retired InternalBugSentinel=117 | retired: DYNAMIC:kind (11)<br>funptr signature type (2)<br>funptr signature kind (2)<br>stackmap statepoint smoke arity mismatch (2)<br>stackmap statepoint smoke caller function (2) | retired ledger: `audit/UMB_retired.csv` | P7-B3.5 retired named/unsafe/FunPtr/stackmap intrinsic contract rows. |
