...
- Final step in progress: stage all task-related changes (including pre-existing uncommitted P10 facade/project-model state that this task depends on), commit with a P10-T06-d message, then stop.
