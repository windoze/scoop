...
| 任务 | 状态 | 文件 | 目标 |
| --- | --- | --- | --- |
| P0-T01 | [TODO] | [`TODO-1.md`](./TODO-1.md#todo-p0-t01删除-package-level-comptime-if-item-与裁剪路径) | 删除 package-level `comptime if` item 与裁剪路径 |
| P0-T01R | [TODO] | [`TODO-1.md`](./TODO-1.md#todo-p0-t01rreview-package-level-comptime-删除结果) | Review package-level comptime 删除结果 |
