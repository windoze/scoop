...
| P2-T05 | [DONE] | [`TODO-2.md`](./TODO-2.md#done-p2-t05新增-operator-modifier-的-lexerparserast-surface) | [DONE] 新增 `operator` modifier 的 lexer/parser/AST surface |
| P2-T05R | [DONE] | [`TODO-2.md`](./TODO-2.md#done-p2-t05rreview-operator-modifier-surface) | [DONE] Review P2-T05 `operator` modifier surface |
...
| P3-T06 | [DONE] | [`TODO-3.md`](./TODO-3.md#done-p3-t06用-ref--value-bound-constraint-kind-替换-anyref--anyvalue-sealed-marker) | [DONE] 用 `ref` / `value` bound constraint kind 替换 `AnyRef` / `AnyValue` |
| P3-T06R | [DONE] | [`TODO-3.md`](./TODO-3.md#done-p3-t06rreview-ref--value-bound-kind-替换结果) | [DONE] Review P3-T06 bound kind 替换结果 |
| P3-T07 | [DONE] | [`TODO-3.md`](./TODO-3.md#done-p3-t07默认-visibility-改为-internal-并同步-sysroot--cone-export) | [DONE] 默认 visibility 改为 `internal` 并同步 sysroot / cone export |
...
| P5-T03 | [DONE] | [`TODO-5.md`](./TODO-5.md#done-p5-t03整合-member--constructor--operator--effect-after-selection-路径) | [DONE] 整合 member / constructor / operator / effect-after-selection 路径 |
...
| P5-T05R | [DONE] | [`TODO-5.md`](./TODO-5.md#done-p5-t05rreview-overload-diagnostics-审计) | [DONE] Review P5-T05 overload diagnostics 审计 |
