...
| 2 | [`TODO-2.md`](./TODO-2.md) | 完整 fact 发布 + self-contained artifact（HIR 分层 source facts / 统一 expression inference / MIR instance·effect-event·provenance·boundary facts / backend contracts 收口 / P4 纯消费） | FG-06/08/09(发布)/10/11(必发)/12/13/15；EFFECT_INFER §3/§4 | 进行中 |
