...
#[cfg(feature = "llvm")]
pub(crate) use llvm_codegen_stage::{LlvmCallableSignatureContract, LlvmCallableSourceContract};
#[cfg(feature = "llvm")]
...
mod tests {
    ...
    fn single_pipeline_p4_ready_mir_stage_publishes_snapshot_facts() {
        ...
        assert_eq!(output.mir_facts().pass_artifacts.revisions.len(), 5);
    }
