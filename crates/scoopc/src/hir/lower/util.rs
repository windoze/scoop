...
use super::super::{
    ...
    ExternFunIndex, File, InterpolatedStringPart, Item, LiteralKind, MemberAccess, MemberRef,
...
pub(super) fn file_contains_source_backed_literals(file: &File) -> bool {
...
fn expr_contains_source_backed_literals(expr: &super::super::Expr) -> bool {
    match &expr.kind {
        super::super::ExprKind::Missing
        | super::super::ExprKind::VarRef(_)
        | super::super::ExprKind::UnresolvedIdent { .. }
        ...
        super::super::ExprKind::TupleLit { elements } => elements
            .iter()
            .any(|e| expr_contains_source_backed_literals(e)),
        super::super::ExprKind::InterpolatedString { parts, .. } => parts.iter().any(|p| match p {
            InterpolatedStringPart::Text { .. } => true,
            InterpolatedStringPart::Expr { expr } => expr_contains_source_backed_literals(expr),
        }),
        super::super::ExprKind::Unary { expr, .. } => expr_contains_source_backed_literals(expr),
        super::super::ExprKind::Binary { lhs, rhs, .. } => {
            expr_contains_source_backed_literals(lhs) || expr_contains_source_backed_literals(rhs)
        }
        super::super::ExprKind::TypeCheck { expr, .. }
        | super::super::ExprKind::Cast { expr, .. } => expr_contains_source_backed_literals(expr),
        super::super::ExprKind::Block(block) => block_contains_source_backed_literals(block),
        super::super::ExprKind::Call { callee, args } => {
        ...
        super::super::ExprKind::Closure(c) => expr_contains_source_backed_literals(&c.body),
        super::super::ExprKind::If {
            cond,
            then_branch,
            else_branch,
        ...
        super::super::ExprKind::MemberAccess { receiver, .. } => {
            expr_contains_source_backed_literals(receiver)
        }
        super::super::ExprKind::Perform { args, .. } => args.iter().any(|a| match a {
            CallArg::Positional(e) => expr_contains_source_backed_literals(e),
            CallArg::Named { value, .. } => expr_contains_source_backed_literals(value),
        }),
        super::super::ExprKind::Handle(h) => {
