...
const REFACTOR_HIR_PLACEHOLDER_INVENTORY: &[InventoryEntry] = &[
    entry(
        ...
        "HIR-T06",
        true,
        "Diagnose empty array literals without expected element type and lower typed arrays with element/result metadata.",
    ),
    entry(
        PlaceholderSurface::ExprTodo,
        "class_lit",
    ...
    entry(
        ...
        "HIR-T02/HIR-T06",
        true,
        "Reject spread outside calls, then canonicalize spread call args only through the typed call-arg contract.",
    ),
    entry(
        PlaceholderSurface::ExprTodo,
        "named_arg",
        ...
        "HIR-T02/HIR-T06",
        true,
        "Reject named args outside calls, then lower accepted call args into ordered/canonical HIR args.",
    ),
    entry(
        PlaceholderSurface::ExprTodo,
