...
use super::{
    ...
    InitializerDependency, InitializerDependencyKind, InitializerRoot, InitializerRootKind, Item,
    LocalDecl, LocalId, LocalSourceKind, MemberAccessMetadata, MemberFunMetadata, MemberTarget,
    MetadataRoot, MirBoxingIntent, MirBoxingReason, MirTransportKind, MirTransportRequirements,
