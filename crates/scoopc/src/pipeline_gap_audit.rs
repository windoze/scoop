...
fn expected_legacy_bucket_hits() -> Vec<String> {
    vec![
        format!(
            "crates/scoopc/src/hir/lower/placeholder_inventory.rs:24:    {LEGACY_BUCKET_MARKER},"
        ),
        format!(
            "crates/scoopc/src/hir/lower/placeholder_inventory.rs:59:    PlaceholderDisposition::{LEGACY_BUCKET_MARKER},"
        ),
        format!(
            "crates/scoopc/src/hir/lower/placeholder_inventory.rs:130:        ALL_DISPOSITIONS.contains(&PlaceholderDisposition::{LEGACY_BUCKET_MARKER}),"
        ),
        format!(
            "crates/scoopc/src/hir/lower/placeholder_inventory.rs:147:            entry.disposition != PlaceholderDisposition::{LEGACY_BUCKET_MARKER}"
        ),
        format!("crates/scoopc/src/mir/placeholder_inventory.rs:25:    {LEGACY_BUCKET_MARKER},"),
        format!(
            "crates/scoopc/src/mir/placeholder_inventory.rs:63:    PlaceholderDisposition::{LEGACY_BUCKET_MARKER},"
        ),
        format!(
            "crates/scoopc/src/mir/placeholder_inventory.rs:116:        PlaceholderDisposition::{LEGACY_BUCKET_MARKER},"
        ),
        format!(
            "crates/scoopc/src/mir/placeholder_inventory.rs:125:        PlaceholderDisposition::{LEGACY_BUCKET_MARKER},"
        ),
        format!(
            "crates/scoopc/src/mir/placeholder_inventory.rs:143:        PlaceholderDisposition::{LEGACY_BUCKET_MARKER},"
        ),
        format!(
            "crates/scoopc/src/mir/placeholder_inventory.rs:152:        PlaceholderDisposition::{LEGACY_BUCKET_MARKER},"
        ),
        format!(
            "crates/scoopc/src/mir/placeholder_inventory.rs:161:        PlaceholderDisposition::{LEGACY_BUCKET_MARKER},"
        ),
        format!(
            "crates/scoopc/src/mir/placeholder_inventory.rs:170:        PlaceholderDisposition::{LEGACY_BUCKET_MARKER},"
        ),
        format!(
            "crates/scoopc/src/mir/placeholder_inventory.rs:179:        PlaceholderDisposition::{LEGACY_BUCKET_MARKER},"
        ),
        format!(
            "crates/scoopc/src/mir/placeholder_inventory.rs:188:        PlaceholderDisposition::{LEGACY_BUCKET_MARKER},"
        ),
        format!(
            "crates/scoopc/src/mir/placeholder_inventory.rs:239:        ALL_DISPOSITIONS.contains(&PlaceholderDisposition::{LEGACY_BUCKET_MARKER}),"
        ),
        format!(
            "crates/scoopc/src/mir/placeholder_inventory.rs:264:            entry.disposition != PlaceholderDisposition::{LEGACY_BUCKET_MARKER}"
        ),
    ]
}
...
fn expected_legacy_reason_hits() -> Vec<String> {
    vec![
        format!(
            r#"crates/scoopc/src/mir/lower.rs:2398:                    self.push_stmt(span, StatementKind::Todo("{REASON_ASSIGN_LHS_MISSING_LOCAL}"));"#
        ),
        format!(
            r#"crates/scoopc/src/mir/lower.rs:2464:                self.push_stmt(span, StatementKind::Todo("{REASON_ASSIGN_LHS_LOWERING_PENDING}"));"#
        ),
        format!(
            r#"crates/scoopc/src/mir/lower.rs:4851:            self.assign(span, result, Rvalue::Todo("{REASON_CALL_CALLEE_LOWERING_PENDING}"));"#
        ),
        format!(
            r#"crates/scoopc/src/mir/lower.rs:4864:                self.assign(span, result, Rvalue::Todo("{REASON_CTOR_CALL_LOWERING_PENDING}"));"#
        ),
        format!(
            r#"crates/scoopc/src/mir/lower.rs:4978:                        Rvalue::Todo("{REASON_SIZEOF_REQUIRES_ARG}"),"#
        ),
        format!(
            r#"crates/scoopc/src/mir/lower.rs:4995:                        Rvalue::Todo("{REASON_NAMEOF_REQUIRES_TYPE_ARG}"),"#
        ),
        format!(
            r#"crates/scoopc/src/mir/lower.rs:5042:                            Rvalue::Todo("{REASON_RESUME_CANONICAL_CALLEE}"),"#
        ),
        format!(
            r#"crates/scoopc/src/mir/lower.rs:5052:                        Rvalue::Todo("{REASON_RESUME_CANONICAL_CALLEE}"),"#
        ),
        format!(
            r#"crates/scoopc/src/mir/lower.rs:5225:                Rvalue::Todo("{REASON_DISPATCH_CALLEE_LOWERING_PENDING}"),"#
        ),
        format!(
            r#"crates/scoopc/src/mir/lower.rs:7170:                            value: Rvalue::Todo("{REASON_CTOR_CALL_LOWERING_PENDING}"),"#
        ),
        format!(
            r#"crates/scoopc/src/mir/lower.rs:7335:                    StatementKind::Todo("{REASON_ASSIGN_LHS_LOWERING_PENDING}")"#
        ),
        format!(
            r#"crates/scoopc/src/mir/materialize.rs:9829:            kind: StatementKind::Todo("{REASON_ASSIGN_LHS_LOWERING_PENDING}"),"#
        ),
        format!(
            r#"crates/scoopc/src/mir/materialize.rs:10167:                reason: "{REASON_ASSIGN_LHS_LOWERING_PENDING}","#
        ),
        format!(
            r#"crates/scoopc/src/mir/mod.rs:2923:            | "{REASON_RESUME_CANONICAL_CALLEE}""#
        ),
        format!(
            r#"crates/scoopc/src/mir/mod.rs:3072:            kind: StatementKind::Todo("{REASON_ASSIGN_LHS_LOWERING_PENDING}"),"#
        ),
        format!(
            r#"crates/scoopc/src/mir/mod.rs:3090:                reason: "{REASON_ASSIGN_LHS_LOWERING_PENDING}","#
        ),
        format!(
            r#"crates/scoopc/src/mir/placeholder_inventory.rs:114:        "{REASON_ASSIGN_LHS_MISSING_LOCAL}","#
        ),
        format!(
            r#"crates/scoopc/src/mir/placeholder_inventory.rs:123:        "{REASON_ASSIGN_LHS_LOWERING_PENDING}","#
        ),
        format!(
            r#"crates/scoopc/src/mir/placeholder_inventory.rs:141:        "{REASON_CALL_CALLEE_LOWERING_PENDING}","#
        ),
        format!(
            r#"crates/scoopc/src/mir/placeholder_inventory.rs:150:        "{REASON_CTOR_CALL_LOWERING_PENDING}","#
        ),
        format!(
            r#"crates/scoopc/src/mir/placeholder_inventory.rs:159:        "{REASON_SIZEOF_REQUIRES_ARG}","#
        ),
        format!(
            r#"crates/scoopc/src/mir/placeholder_inventory.rs:168:        "{REASON_NAMEOF_REQUIRES_TYPE_ARG}","#
        ),
        format!(
            r#"crates/scoopc/src/mir/placeholder_inventory.rs:177:        "{REASON_RESUME_CANONICAL_CALLEE}","#
        ),
        format!(
            r#"crates/scoopc/src/mir/placeholder_inventory.rs:186:        "{REASON_DISPATCH_CALLEE_LOWERING_PENDING}","#
        ),
        format!(
            r#"crates/scoopc/src/pipeline/hir_preflight.rs:120:    "{REASON_ASSIGN_LHS_MISSING_LOCAL}","#
        ),
        format!(
            r#"crates/scoopc/src/pipeline/hir_preflight.rs:121:    "{REASON_ASSIGN_LHS_LOWERING_PENDING}","#
        ),
        format!(
            r#"crates/scoopc/src/pipeline/hir_preflight.rs:125:    "{REASON_CALL_CALLEE_LOWERING_PENDING}","#
        ),
        format!(
            r#"crates/scoopc/src/pipeline/hir_preflight.rs:126:    "{REASON_CTOR_CALL_LOWERING_PENDING}","#
        ),
        format!(
            r#"crates/scoopc/src/pipeline/hir_preflight.rs:127:    "{REASON_RESUME_CANONICAL_CALLEE}","#
        ),
        format!(
            r#"crates/scoopc/src/pipeline/hir_preflight.rs:128:    "{REASON_DISPATCH_CALLEE_LOWERING_PENDING}","#
        ),
        format!(
            r#"crates/scoopc/src/pipeline/hir_stage.rs:3676:                        crate::mir::StatementKind::Todo("{REASON_ASSIGN_LHS_LOWERING_PENDING}")"#
        ),
        format!(
            r#"crates/scoopc/src/pipeline/mir_stage.rs:492:            "{REASON_ASSIGN_LHS_LOWERING_PENDING}","#
        ),
        format!(
            r#"crates/scoopc/src/pipeline/mir_stage.rs:608:            "{REASON_CALL_CALLEE_LOWERING_PENDING}","#
        ),
        format!(
            r#"crates/scoopc/src/pipeline/mir_stage.rs:609:            "{REASON_CTOR_CALL_LOWERING_PENDING}","#
        ),
        format!(
            r#"crates/scoopc/src/pipeline/mir_stage.rs:610:            "{REASON_SIZEOF_REQUIRES_ARG}","#
        ),
    ]
}
