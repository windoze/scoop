...
pub(super) const SCOOP_TASK_POLL: &str = "scoop_task_poll";
pub(super) const SCOOP_TASK_STEP_PENDING: &str = "scoop_task_step_pending";
pub(super) const SCOOP_TASK_STEP_READY: &str = "scoop_task_step_ready";
