...
pub(super) const SCOOP_STRING_SPLIT: &str = "scoop_string_split";
pub(super) const SCOOP_STRING_STARTS_WITH: &str = "scoop_string_starts_with";
pub(super) const SCOOP_STRING_SUBSTRING: &str = "scoop_string_substring";
pub(super) const SCOOP_STRING_TO_INT: &str = "scoop_string_to_int";
pub(super) const SCOOP_STRING_TRIM: &str = "scoop_string_trim";
