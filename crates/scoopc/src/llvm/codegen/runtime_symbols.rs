...
pub(super) const SCOOP_TASK_COMPLETE: &str = "scoop_task_complete";
pub(super) const SCOOP_TASK_CREATE: &str = "scoop_task_create";
pub(super) const SCOOP_TASK_CREATE_MANUAL: &str = "scoop_task_create_manual";
pub(super) const SCOOP_TASK_FROM_RESULT: &str = "scoop_task_from_result";
pub(super) const SCOOP_TASK_JOIN: &str = "scoop_task_join";
pub(super) const SCOOP_TASK_ON_COMPLETE: &str = "scoop_task_on_complete";
pub(super) const SCOOP_TASK_RESULT_GC_REF: &str = "scoop_task_result_gc_ref";
pub(super) const SCOOP_TASK_RESULT_WORD: &str = "scoop_task_result_word";
pub(super) const SCOOP_TASK_STATE: &str = "scoop_task_state";
pub(super) const SCOOP_TASK_TRY_START: &str = "scoop_task_try_start";
