...
const INTERNAL_BUG_SENTINEL_HITS: &[&str] = &[
    ...
    "crates/scoopc/src/llvm/codegen/mir_body/args.rs:261:            panic!(\"codegen_bound_mir_call_args_from_signature: MIR call ABI verifier accepted arg binding drift\")",
    "crates/scoopc/src/llvm/codegen/mir_body/args.rs:277:                    panic!(\"codegen_bound_mir_call_args_from_signature: TypeStore equivalence verifier accepted unsupported call arg type\")",
    "crates/scoopc/src/llvm/codegen/mir_body/args.rs:295:                    panic!(\"codegen_bound_mir_call_args_from_signature: MIR call ABI verifier accepted missing evaluated arg slot\")",
    "crates/scoopc/src/llvm/codegen/mir_body/args.rs:354:            panic!(\"codegen_bound_materialized_mir_call_args: MIR call ABI verifier accepted arg binding drift\")",
    "crates/scoopc/src/llvm/codegen/mir_body/args.rs:363:                panic!(\"codegen_bound_materialized_mir_call_args: TypeStore equivalence verifier accepted unsupported call arg type\")",
    "crates/scoopc/src/llvm/codegen/mir_body/args.rs:381:                    panic!(\"codegen_bound_materialized_mir_call_args: MIR call ABI verifier accepted missing evaluated arg slot\")",
    "crates/scoopc/src/llvm/codegen/mir_body/args.rs:385:                    panic!(",
    ...
    "crates/scoopc/src/llvm/codegen/mir_body/call.rs:138:            panic!(\"codegen_mir_direct_call_with_policy: MIR call ABI verifier accepted missing direct callee signature\");",
    "crates/scoopc/src/llvm/codegen/mir_body/call.rs:197:                    panic!(\"codegen_mir_direct_call_with_policy: MIR call ABI verifier accepted arg binding drift\")",
    "crates/scoopc/src/llvm/codegen/mir_body/call.rs:263:            panic!(\"codegen_mir_direct_call_with_policy: MIR call ABI verifier accepted signature arity mismatch\");",
    "crates/scoopc/src/llvm/codegen/mir_body/call.rs:266:            panic!(\"codegen_mir_direct_call_with_policy: MIR call ABI verifier accepted direct call arity mismatch\");",
    "crates/scoopc/src/llvm/codegen/mir_body/call.rs:314:                panic!(\"codegen_mir_direct_call_with_policy: MIR call ABI verifier accepted unsupported direct call return type\")",
    "crates/scoopc/src/llvm/codegen/mir_body/call.rs:464:                            panic!(\"codegen_mir_direct_call_with_policy: MIR call ABI verifier accepted missing deferred return value\")",
    "crates/scoopc/src/llvm/codegen/mir_body/call.rs:546:            panic!(\"codegen_mir_fun_value_call: MIR call ABI verifier accepted non-pointer function-value callee\");",
    "crates/scoopc/src/llvm/codegen/mir_body/call.rs:655:            panic!(\"codegen_mir_function_value_call_from_closure_obj: MIR call ABI verifier accepted function-value arity mismatch\");",
    "crates/scoopc/src/llvm/codegen/mir_body/call.rs:667:                panic!(\"codegen_mir_function_value_call_from_closure_obj: MIR call ABI verifier accepted unsupported function-value return type\")",
    "crates/scoopc/src/llvm/codegen/mir_body/call.rs:702:            (None, CgTy::Tuple(_) | CgTy::Struct(_) | CgTy::Enum(_)) => unreachable!(",
    "crates/scoopc/src/llvm/codegen/mir_body/call.rs:819:                            panic!(\"codegen_mir_function_value_call_from_closure_obj: MIR call ABI verifier accepted missing deferred return value\")",
    "crates/scoopc/src/llvm/codegen/mir_body/call.rs:891:                        panic!(\"codegen_mir_plain_dynamic_call_with_policy: MIR call ABI verifier accepted non-function plain function-value callee\")",
    "crates/scoopc/src/llvm/codegen/mir_body/call.rs:961:                panic!(\"codegen_mir_plain_dynamic_call_with_policy: MIR call ABI verifier accepted unsupported plain dynamic call kind\")",
    "crates/scoopc/src/llvm/codegen/mir_body/call.rs:978:            panic!(\"codegen_mir_plain_function_value_call: MIR call ABI verifier accepted non-pointer plain function-value callee\");",
    "crates/scoopc/src/llvm/codegen/mir_body/callable_lookup.rs:215:        panic!(\"materialized_mir_callable_source_id: MIR call ABI verifier accepted callable without source path\")",
    "crates/scoopc/src/llvm/codegen/mir_body/callable_lookup.rs:334:            panic!(\"declare_materialized_mir_plain_fun_with_symbol: MIR call ABI verifier accepted unsupported plain return type\")",
    "crates/scoopc/src/llvm/codegen/mir_body/callable_lookup.rs:351:                panic!(\"declare_materialized_mir_plain_fun_with_symbol: TypeStore equivalence verifier accepted unsupported plain param type\")",
    "crates/scoopc/src/llvm/codegen/mir_body/callable_lookup.rs:395:            panic!(\"codegen_materialized_mir_closure_fun: MIR call ABI verifier accepted invalid CFG\")",
    "crates/scoopc/src/llvm/codegen/mir_body/callable_lookup.rs:418:                        panic!(\"codegen_materialized_mir_closure_fun: MIR call ABI verifier accepted missing sret param\")",
    "crates/scoopc/src/llvm/codegen/mir_body/callable_lookup.rs:451:                panic!(\"codegen_materialized_mir_closure_fun: MIR call ABI verifier accepted missing start block\")",
    "crates/scoopc/src/llvm/codegen/mir_body/callable_lookup.rs:524:                    panic!(\"bind_mir_closure_params: MIR call ABI verifier accepted missing param local slot\")",
    "crates/scoopc/src/llvm/codegen/mir_body/callable_lookup.rs:527:                panic!(\"bind_mir_closure_params: TypeStore equivalence verifier accepted unsupported param type\")",
    "crates/scoopc/src/llvm/codegen/mir_body/callable_lookup.rs:534:                        panic!(\"bind_mir_closure_params: MIR call ABI verifier accepted missing LLVM param\")",
    ...
    "crates/scoopc/src/llvm/codegen/mir_body/cast.rs:93:                panic!(\"codegen_mir_cast_as: MIR verifier accepted unsupported `as` target type\")",
    "crates/scoopc/src/llvm/codegen/mir_body/cast.rs:140:            panic!(\"codegen_mir_cast_asq: MIR verifier accepted invalid `as?` failure contract\");",
    "crates/scoopc/src/llvm/codegen/mir_body/cast.rs:143:            panic!(\"codegen_mir_cast_asq: MIR verifier accepted invalid `as?` result contract\");",
    "crates/scoopc/src/llvm/codegen/mir_body/cast.rs:146:            panic!(\"codegen_mir_cast_asq: MIR verifier accepted invalid `as?` target contract\");",
    "crates/scoopc/src/llvm/codegen/mir_body/cast.rs:152:                panic!(\"codegen_mir_cast_asq: TypeStore equivalence verifier accepted unsupported `as?` target codegen type\")",
    ...
    "crates/scoopc/src/llvm/codegen/mir_body/cast.rs:167:                panic!(\"codegen_mir_cast_asq: TypeStore equivalence verifier accepted unsupported `as?` option codegen type\")",
    "crates/scoopc/src/llvm/codegen/mir_body/cast.rs:170:            panic!(\"codegen_mir_cast_asq: MIR verifier accepted invalid `as?` result type\");",
    "crates/scoopc/src/llvm/codegen/mir_body/cast.rs:259:            _ => panic!(\"runtime_cast_target_ptr_type: MIR verifier accepted non-runtime-ref cast target type\"),",
    "crates/scoopc/src/llvm/codegen/mir_body/cast.rs:341:            panic!(\"codegen_checked_runtime_ref_cast_option: verified Option Some produced no value\")",
    "crates/scoopc/src/llvm/codegen/mir_body/cast.rs:348:            panic!(\"codegen_checked_runtime_ref_cast_option: verified Option None produced no value\")",
    ...
    "crates/scoopc/src/llvm/codegen/main/expr_op.rs:217:            panic!(\"codegen_cast_asq_expr: typecheck gate accepted non-Option `as?` result type\");",
    "crates/scoopc/src/llvm/codegen/main/expr_op.rs:230:                panic!(\"codegen_cast_asq_expr: typecheck gate accepted non-runtime-ref `as?` target\");",
    "crates/scoopc/src/llvm/codegen/main/expr_op.rs:239:                panic!(\"codegen_cast_asq_expr: typecheck gate accepted non-runtime-ref `as?` operand\");",
    "crates/scoopc/src/llvm/codegen/main/expr_op.rs:243:            panic!(\"codegen_cast_asq_expr: typecheck gate accepted valueless `as?` operand\");",
    "crates/scoopc/src/llvm/codegen/main/expr_op.rs:246:            panic!(\"codegen_cast_asq_expr: typecheck gate accepted non-pointer `as?` operand\");",
    "crates/scoopc/src/llvm/codegen/main/expr_op.rs:271:            panic!(\"codegen_cast_asq_expr: verified Option Some produced no value\")",
    "crates/scoopc/src/llvm/codegen/main/expr_op.rs:279:            panic!(\"codegen_cast_asq_expr: verified Option None produced no value\")",
    "crates/scoopc/src/llvm/codegen/main/expr_op.rs:392:                panic!(\"codegen_ref_is_instance_of_nonnull: typecheck gate accepted unsupported nominal runtime target\")",
    "crates/scoopc/src/llvm/codegen/main/expr_op.rs:394:            _ => panic!(\"codegen_ref_is_instance_of_nonnull: typecheck gate accepted unsupported runtime target type\"),",
    ...
    "crates/scoopc/src/llvm/codegen/main/gc_locals.rs:84:            panic!(\"rematerialize_ptr_in_current_block: local slot GEP must publish source type\")",
    ...
    "crates/scoopc/src/llvm/codegen/main/runtime_error.rs:224:            panic!(\"emit_raise_runtime_error_variant: TypeStore equivalence verifier accepted non-enum RuntimeError payload type\");",
