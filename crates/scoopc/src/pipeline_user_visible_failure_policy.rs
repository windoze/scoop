...
const INTERNAL_BUG_SENTINEL_HITS: &[&str] = &[
    ...
    "crates/scoopc_codegen_llvm/src/llvm/codegen/mir_body/args.rs:26:                panic!(\"codegen_mir_class_ctor_ordered_args: MIR verifier accepted {kind}\");",
    "crates/scoopc_codegen_llvm/src/llvm/codegen/mir_body/args.rs:45:                    panic!(\"codegen_mir_class_ctor_ordered_args: MIR verifier accepted {kind}\")",
    "crates/scoopc_codegen_llvm/src/llvm/codegen/mir_body/args.rs:254:            panic!(\"codegen_bound_mir_call_args_from_signature: MIR call ABI verifier accepted arg binding drift\")",
    "crates/scoopc_codegen_llvm/src/llvm/codegen/mir_body/args.rs:270:                    panic!(\"codegen_bound_mir_call_args_from_signature: TypeStore equivalence verifier accepted unsupported call arg type\")",
    "crates/scoopc_codegen_llvm/src/llvm/codegen/mir_body/args.rs:288:                    panic!(\"codegen_bound_mir_call_args_from_signature: MIR call ABI verifier accepted missing evaluated arg slot\")",
