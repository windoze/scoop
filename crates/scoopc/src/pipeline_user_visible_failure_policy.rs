...
const INTERNAL_BUG_SENTINEL_HITS: &[&str] = &[
    ...
    "crates/scoopc/src/llvm/codegen/mir_body/call.rs:553:            panic!(",
    "crates/scoopc/src/llvm/codegen/mir_body/call.rs:664:            panic!(",
    "crates/scoopc/src/llvm/codegen/mir_body/call.rs:678:                panic!(\"codegen_mir_function_value_call_from_closure_obj: MIR call ABI verifier accepted unsupported function-value return type\")",
    "crates/scoopc/src/llvm/codegen/mir_body/call.rs:713:            (None, CgTy::Tuple(_) | CgTy::Struct(_) | CgTy::Enum(_)) => unreachable!(",
    "crates/scoopc/src/llvm/codegen/mir_body/call.rs:830:                            panic!(\"codegen_mir_function_value_call_from_closure_obj: MIR call ABI verifier accepted missing deferred return value\")",
    "crates/scoopc/src/llvm/codegen/mir_body/call.rs:902:                        panic!(\"codegen_mir_plain_dynamic_call_with_policy: MIR call ABI verifier accepted non-function plain function-value callee\")",
    "crates/scoopc/src/llvm/codegen/mir_body/call.rs:972:                panic!(",
    "crates/scoopc/src/llvm/codegen/mir_body/call.rs:991:            panic!(",
