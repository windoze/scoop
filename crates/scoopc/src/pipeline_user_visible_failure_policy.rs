...
const INTERNAL_BUG_SENTINEL_HITS: &[&str] = &[
    ...
    "crates/scoopc/src/llvm/codegen/mir_body/args.rs:19:            panic!(\"codegen_mir_class_ctor_ordered_args: MIR verifier accepted {kind}\");",
    "crates/scoopc/src/llvm/codegen/mir_body/args.rs:25:                panic!(\"codegen_mir_class_ctor_ordered_args: MIR verifier accepted {kind}\");",
    ...
    "crates/scoopc/src/llvm/codegen/mir_body/call.rs:171:            panic!(",
    "crates/scoopc/src/llvm/codegen/mir_body/call.rs:176:            panic!(",
    "crates/scoopc/src/llvm/codegen/mir_body/call.rs:203:                panic!(\"codegen_mir_direct_call_with_policy: MIR call ABI verifier accepted unsupported direct call return type\")",
    "crates/scoopc/src/llvm/codegen/mir_body/call.rs:327:                            panic!(\"codegen_mir_direct_call_with_policy: MIR call ABI verifier accepted missing deferred return value\")",
    "crates/scoopc/src/llvm/codegen/mir_body/call.rs:345:            .unwrap_or_else(|| panic!(\"codegen_mir_class_ctor_call_at_site: verifier accepted missing class ctor call site\"));",
    "crates/scoopc/src/llvm/codegen/mir_body/call.rs:379:            panic!(",
    "crates/scoopc/src/llvm/codegen/mir_body/call.rs:405:            panic!(",
    "crates/scoopc/src/llvm/codegen/mir_body/call.rs:432:            panic!(",
    "crates/scoopc/src/llvm/codegen/mir_body/call.rs:438:            panic!(",
    "crates/scoopc/src/llvm/codegen/mir_body/call.rs:494:                    panic!(",
    "crates/scoopc/src/llvm/codegen/mir_body/call.rs:514:            panic!(",
    "crates/scoopc/src/llvm/codegen/mir_body/call.rs:528:                panic!(\"codegen_mir_function_value_call_from_closure_obj: MIR call ABI verifier accepted unsupported function-value return type\")",
    "crates/scoopc/src/llvm/codegen/mir_body/call.rs:563:            (None, CgTy::Tuple(_) | CgTy::Struct(_) | CgTy::Enum(_)) => unreachable!(",
    "crates/scoopc/src/llvm/codegen/mir_body/call.rs:680:                            panic!(\"codegen_mir_function_value_call_from_closure_obj: MIR call ABI verifier accepted missing deferred return value\")",
    "crates/scoopc/src/llvm/codegen/mir_body/call.rs:718:                        panic!(\"codegen_mir_plain_dynamic_call_with_policy: MIR verifier accepted non-function plain closure callee\")",
    "crates/scoopc/src/llvm/codegen/mir_body/call.rs:732:                            panic!(",
    "crates/scoopc/src/llvm/codegen/mir_body/call.rs:737:                            panic!(",
    "crates/scoopc/src/llvm/codegen/mir_body/call.rs:749:                        panic!(\"codegen_mir_plain_dynamic_call_with_policy: MIR call ABI verifier accepted non-function plain function-value callee\")",
    "crates/scoopc/src/llvm/codegen/mir_body/call.rs:758:                            panic!(",
    "crates/scoopc/src/llvm/codegen/mir_body/call.rs:763:                            panic!(",
    "crates/scoopc/src/llvm/codegen/mir_body/call.rs:775:                        panic!(",
    "crates/scoopc/src/llvm/codegen/mir_body/call.rs:780:                    panic!(",
    "crates/scoopc/src/llvm/codegen/mir_body/call.rs:817:                panic!(",
    "crates/scoopc/src/llvm/codegen/mir_body/call.rs:836:            panic!(",
    "crates/scoopc/src/llvm/codegen/mir_body/callable_lookup.rs:116:            panic!(",
    "crates/scoopc/src/llvm/codegen/mir_body/callable_lookup.rs:121:            panic!(\"ensure_lir_source_closure_callable_defined: callable is not a closure body\")",
    "crates/scoopc/src/llvm/codegen/mir_body/callable_lookup.rs:162:        panic!(",
    "crates/scoopc/src/llvm/codegen/mir_body/callable_lookup.rs:209:            panic!(\"declare_lir_source_closure_fun_with_signature: LIR source verifier accepted unsupported closure return type\")",
    "crates/scoopc/src/llvm/codegen/mir_body/callable_lookup.rs:231:                    panic!(\"declare_lir_source_closure_fun_with_signature: TypeStore equivalence verifier accepted unsupported closure param type\")",
    "crates/scoopc/src/llvm/codegen/mir_body/callable_lookup.rs:285:            panic!(\"declare_lir_source_plain_fun_with_symbol: LIR source ABI verifier accepted unsupported plain return type\")",
    "crates/scoopc/src/llvm/codegen/mir_body/callable_lookup.rs:303:                panic!(\"declare_lir_source_plain_fun_with_symbol: TypeStore equivalence verifier accepted unsupported plain param type\")",
    "crates/scoopc/src/llvm/codegen/mir_body/callable_lookup.rs:377:                        panic!(\"declare_lir_plain_fun_with_symbol: TypeStore equivalence verifier accepted unsupported plain param type\")",
    "crates/scoopc/src/llvm/codegen/mir_body/callable_lookup.rs:399:                panic!(\"declare_lir_plain_fun_with_symbol: LIR facts verifier accepted unsupported plain return type\")",
    "crates/scoopc/src/llvm/codegen/mir_body/callable_lookup.rs:480:            panic!(\"codegen_lir_source_closure_fun: LIR source ABI verifier accepted invalid CFG\")",
    "crates/scoopc/src/llvm/codegen/mir_body/callable_lookup.rs:488:                panic!(\"codegen_lir_source_closure_fun: LIR source verifier accepted unsupported closure return type\")",
    "crates/scoopc/src/llvm/codegen/mir_body/callable_lookup.rs:502:                        panic!(\"codegen_lir_source_closure_fun: LIR source ABI verifier accepted missing sret param\")",
    "crates/scoopc/src/llvm/codegen/mir_body/callable_lookup.rs:535:                panic!(\"codegen_lir_source_closure_fun: LIR source ABI verifier accepted missing start block\")",
    "crates/scoopc/src/llvm/codegen/mir_body/callable_lookup.rs:575:            panic!(\"bind_mir_closure_params: MIR verifier accepted closure without env param\")",
    "crates/scoopc/src/llvm/codegen/mir_body/callable_lookup.rs:578:            panic!(",
    "crates/scoopc/src/llvm/codegen/mir_body/callable_lookup.rs:586:                panic!(\"bind_mir_closure_params: MIR verifier accepted missing env local slot\")",
    "crates/scoopc/src/llvm/codegen/mir_body/callable_lookup.rs:602:                    panic!(\"bind_mir_closure_params: MIR call ABI verifier accepted missing param local slot\")",
    "crates/scoopc/src/llvm/codegen/mir_body/callable_lookup.rs:605:                panic!(\"bind_mir_closure_params: TypeStore equivalence verifier accepted unsupported param type\")",
    "crates/scoopc/src/llvm/codegen/mir_body/callable_lookup.rs:612:                        panic!(\"bind_mir_closure_params: MIR call ABI verifier accepted missing LLVM param\")",
    "crates/scoopc/src/llvm/codegen/mir_body/callable_lookup.rs:647:                        panic!(\"codegen_mir_closure_env_param: MIR verifier accepted non-tuple closure env\")",
    "crates/scoopc/src/llvm/codegen/mir_body/callable_lookup.rs:652:                        panic!(",
    "crates/scoopc/src/llvm/codegen/mir_body/callable_lookup.rs:692:            _ => panic!(",
    ...
    "crates/scoopc/src/llvm/codegen/mir_body/dispatch.rs:293:            panic!(",
    "crates/scoopc/src/llvm/codegen/mir_body/dispatch.rs:328:                panic!(",
    "crates/scoopc/src/llvm/codegen/mir_body/dispatch.rs:374:                panic!(",
    "crates/scoopc/src/llvm/codegen/mir_body/dispatch.rs:416:            .unwrap_or_else(|| panic!(\"codegen_mir_plain_dispatch_call: verifier accepted missing dispatch receiver pointer\"));",
    "crates/scoopc/src/llvm/codegen/mir_body/dispatch.rs:551:                    .unwrap_or_else(|| panic!(\"selected_mir_class_ctor_from_contract: verifier accepted missing selected ctor\")),",
    "crates/scoopc/src/llvm/codegen/mir_body/dispatch.rs:555:                panic!(\"selected_mir_class_ctor_from_contract: verifier accepted unselected ctor contract\");",
    ...
    "crates/scoopc/src/llvm/codegen/mir_body/operand.rs:349:            panic!(\"mir_closure_env_capture_element_cg_tys_from_contract: TypeStore equivalence verifier accepted unsupported closure env contract codegen type\")",
    "crates/scoopc/src/llvm/codegen/mir_body/operand.rs:352:            panic!(",
    "crates/scoopc/src/llvm/codegen/mir_body/operand.rs:360:                panic!(\"mir_closure_env_capture_element_cg_tys_from_contract: MIR verifier accepted non-tuple closure env\")",
    "crates/scoopc/src/llvm/codegen/mir_body/operand.rs:363:            panic!(",
    "crates/scoopc/src/llvm/codegen/mir_body/operand.rs:385:            _ => panic!(",
    "crates/scoopc/src/llvm/codegen/mir_body/operand.rs:396:                        panic!(\"mir_closure_env_capture_element_cg_tys_from_contract: MIR verifier accepted missing closure env capture element\")",
    "crates/scoopc/src/llvm/codegen/mir_body/operand.rs:401:                panic!(",
    ...
    "crates/scoopc/src/llvm/codegen/mir_body/types.rs:747:                panic!(\"mir_member_receiver_codegen_type_id: verifier accepted member receiver TypeStore drift\")",
    ...
    "crates/scoopc/src/llvm/codegen/effect_lowered/body/runtime_error.rs:84:                panic!(\"runtime_error_unit_variant_payload: verifier accepted missing RuntimeError LIR enum layout\")",
    "crates/scoopc/src/llvm/codegen/effect_lowered/body/runtime_error.rs:91:                panic!(\"runtime_error_unit_variant_payload: verifier accepted missing RuntimeError variant `{variant_name}`\")",
    "crates/scoopc/src/llvm/codegen/effect_lowered/body/runtime_error.rs:94:            panic!(",
    "crates/scoopc/src/llvm/codegen/effect_lowered/body/runtime_error.rs:150:                panic!(",
    ...
    "crates/scoopc/src/llvm/codegen/effect_lowered/value.rs:949:            panic!(",
    "crates/scoopc/src/llvm/codegen/effect_lowered/value.rs:1009:            panic!(",
    "crates/scoopc/src/llvm/codegen/effect_lowered/value.rs:1342:                panic!(",
    "crates/scoopc/src/llvm/codegen/effect_lowered/value.rs:1383:                panic!(",
    "crates/scoopc/src/llvm/codegen/effect_lowered/value.rs:1431:                    panic!(",
    "crates/scoopc/src/llvm/codegen/effect_lowered/value.rs:1551:                    panic!(",
    "crates/scoopc/src/llvm/codegen/effect_lowered/value.rs:1577:                panic!(",
    "crates/scoopc/src/llvm/codegen/effect_lowered/value.rs:1615:                panic!(",
    "crates/scoopc/src/llvm/codegen/effect_lowered/value.rs:1722:                panic!(",
    "crates/scoopc/src/llvm/codegen/effect_lowered/value.rs:2287:                panic!(",
    "crates/scoopc/src/llvm/codegen/effect_lowered/value.rs:2318:                        panic!(",
    "crates/scoopc/src/llvm/codegen/effect_lowered/value.rs:2326:                    _ => unreachable!(\"filtered by match\"),",
    "crates/scoopc/src/llvm/codegen/effect_lowered/value.rs:2351:            _ => panic!(",
    "crates/scoopc/src/llvm/codegen/effect_lowered/value.rs:2379:                panic!(",
    "crates/scoopc/src/llvm/codegen/effect_lowered/value.rs:2397:                        panic!(",
    "crates/scoopc/src/llvm/codegen/effect_lowered/value.rs:2421:                            panic!(",
    "crates/scoopc/src/llvm/codegen/effect_lowered/value.rs:2434:                _ => panic!(",
    "crates/scoopc/src/llvm/codegen/effect_lowered/value.rs:2653:                panic!(",
    "crates/scoopc/src/llvm/codegen/effect_lowered/value.rs:2938:            panic!(",
    "crates/scoopc/src/llvm/codegen/effect_lowered/value.rs:2948:                panic!(",
    "crates/scoopc/src/llvm/codegen/effect_lowered/value.rs:2972:            panic!(",
    "crates/scoopc/src/llvm/codegen/effect_lowered/value.rs:2984:                        panic!(",
    "crates/scoopc/src/llvm/codegen/effect_lowered/value.rs:2995:                panic!(",
    "crates/scoopc/src/llvm/codegen/effect_lowered/value.rs:3010:                        panic!(",
    "crates/scoopc/src/llvm/codegen/effect_lowered/value.rs:3016:                panic!(",
    "crates/scoopc/src/llvm/codegen/effect_lowered/value.rs:3037:                    panic!(",
    "crates/scoopc/src/llvm/codegen/effect_lowered/value.rs:3119:            panic!(",
    "crates/scoopc/src/llvm/codegen/effect_lowered/value.rs:3129:                panic!(",
    "crates/scoopc/src/llvm/codegen/effect_lowered/value.rs:3403:                panic!(",
    "crates/scoopc/src/llvm/codegen/effect_lowered/value.rs:3424:            _ => unreachable!(\"filtered by caller\"),",
    "crates/scoopc/src/llvm/codegen/effect_lowered/value.rs:3737:            panic!(",
    "crates/scoopc/src/llvm/codegen/effect_lowered/value.rs:3760:                        panic!(",
    "crates/scoopc/src/llvm/codegen/effect_lowered/value.rs:3808:                            panic!(",
    "crates/scoopc/src/llvm/codegen/effect_lowered/value.rs:3937:                panic!(",
    ...
    "crates/scoopc/src/llvm/codegen/main/call.rs:714:            unreachable!(",
    ...
    "crates/scoopc/src/llvm/codegen/main/context.rs:469:            .unwrap_or_else(|| panic!(\"{context}: LIR facts are missing global root `{fqn}`\"));",
    "crates/scoopc/src/llvm/codegen/main/context.rs:471:            panic!(",
    "crates/scoopc/src/llvm/codegen/main/context.rs:486:            panic!(",
    "crates/scoopc/src/llvm/codegen/main/context.rs:499:            panic!(",
    "crates/scoopc/src/llvm/codegen/main/context.rs:522:                panic!(\"source_slice_at: parser/typecheck accepted a span outside its source\")",
    "crates/scoopc/src/llvm/codegen/main/context.rs:525:            panic!(\"source_slice_at: parser/typecheck accepted an unsliceable source span\")",
    "crates/scoopc/src/llvm/codegen/main/declare.rs:140:            panic!(",
    "crates/scoopc/src/llvm/codegen/main/declare.rs:146:            panic!(",
    ...
    "crates/scoopc/src/llvm/codegen/main/function.rs:54:                    panic!(\"emit_function_return_block: function return context must publish return alloca\")",
    ...
    "crates/scoopc/src/llvm/codegen/main/identity.rs:376:            panic!(\"stable_closure_key_for_lir_source_callable: LIR source contract accepted missing closure callable\")",
    "crates/scoopc/src/llvm/codegen/main/identity.rs:379:            panic!(\"stable_closure_key_for_lir_source_callable: callable is not a closure body\")",
    "crates/scoopc/src/llvm/codegen/main/identity.rs:409:            panic!(\"direct_hir_closure_callable_fqn: closure codegen requires current callable owner\")",
    ...
    "crates/scoopc/src/llvm/codegen/mod.rs:953:                    panic!(",
    "crates/scoopc/src/llvm/codegen/mod.rs:963:                            panic!(",
    "crates/scoopc/src/llvm/codegen/mod.rs:974:                                panic!(",
