...
const INTERNAL_BUG_SENTINEL_HITS: &[&str] = &[
    ...
    "crates/scoopc/src/llvm/codegen/mir_body/aggregates.rs:446:            panic!(",
    "crates/scoopc/src/llvm/codegen/mir_body/aggregates.rs:488:            panic!(\"scoop_alloc_typed closure allocation must return a pointer\");",
    "crates/scoopc/src/llvm/codegen/mir_body/aggregates.rs:545:                panic!(\"scoop_alloc_typed closure env allocation must return a pointer\");",
    "crates/scoopc/src/llvm/codegen/mir_body/aggregates.rs:562:                    panic!(",
    ...
    "crates/scoopc/src/llvm/codegen/mir_body/call.rs:523:            panic!(",
    "crates/scoopc/src/llvm/codegen/mir_body/call.rs:549:            panic!(",
    "crates/scoopc/src/llvm/codegen/mir_body/call.rs:576:            panic!(",
    "crates/scoopc/src/llvm/codegen/mir_body/call.rs:582:            panic!(",
    "crates/scoopc/src/llvm/codegen/mir_body/call.rs:638:                    panic!(",
    "crates/scoopc/src/llvm/codegen/mir_body/call.rs:658:            panic!(",
    "crates/scoopc/src/llvm/codegen/mir_body/call.rs:672:                panic!(\"codegen_mir_function_value_call_from_closure_obj: MIR call ABI verifier accepted unsupported function-value return type\")",
    "crates/scoopc/src/llvm/codegen/mir_body/call.rs:707:            (None, CgTy::Tuple(_) | CgTy::Struct(_) | CgTy::Enum(_)) => unreachable!(",
    "crates/scoopc/src/llvm/codegen/mir_body/call.rs:824:                            panic!(\"codegen_mir_function_value_call_from_closure_obj: MIR call ABI verifier accepted missing deferred return value\")",
    "crates/scoopc/src/llvm/codegen/mir_body/call.rs:862:                        panic!(\"codegen_mir_plain_dynamic_call_with_policy: MIR verifier accepted non-function plain closure callee\")",
    "crates/scoopc/src/llvm/codegen/mir_body/call.rs:876:                            panic!(",
    "crates/scoopc/src/llvm/codegen/mir_body/call.rs:881:                            panic!(",
    "crates/scoopc/src/llvm/codegen/mir_body/call.rs:893:                        panic!(\"codegen_mir_plain_dynamic_call_with_policy: MIR call ABI verifier accepted non-function plain function-value callee\")",
    "crates/scoopc/src/llvm/codegen/mir_body/call.rs:902:                            panic!(",
    "crates/scoopc/src/llvm/codegen/mir_body/call.rs:907:                            panic!(",
    "crates/scoopc/src/llvm/codegen/mir_body/call.rs:919:                        panic!(",
    "crates/scoopc/src/llvm/codegen/mir_body/call.rs:924:                    panic!(",
    "crates/scoopc/src/llvm/codegen/mir_body/call.rs:961:                panic!(",
    "crates/scoopc/src/llvm/codegen/mir_body/call.rs:980:            panic!(",
    ...
    "crates/scoopc/src/llvm/codegen/mir_body/cast.rs:90:            panic!(\"codegen_mir_cast_as: MIR verifier accepted unsupported `as` target type\")",
    "crates/scoopc/src/llvm/codegen/mir_body/cast.rs:137:            panic!(\"codegen_mir_cast_asq: MIR verifier accepted invalid `as?` failure contract\");",
    "crates/scoopc/src/llvm/codegen/mir_body/cast.rs:140:            panic!(\"codegen_mir_cast_asq: MIR verifier accepted invalid `as?` result contract\");",
    "crates/scoopc/src/llvm/codegen/mir_body/cast.rs:143:            panic!(\"codegen_mir_cast_asq: MIR verifier accepted invalid `as?` target contract\");",
    "crates/scoopc/src/llvm/codegen/mir_body/cast.rs:149:                panic!(\"codegen_mir_cast_asq: TypeStore equivalence verifier accepted unsupported `as?` target codegen type\")",
    "crates/scoopc/src/llvm/codegen/mir_body/cast.rs:152:            panic!(\"codegen_mir_cast_asq: MIR verifier accepted unsupported `as?` target type\")",
    "crates/scoopc/src/llvm/codegen/mir_body/cast.rs:155:            panic!(",
    "crates/scoopc/src/llvm/codegen/mir_body/cast.rs:162:                panic!(\"codegen_mir_cast_asq: TypeStore equivalence verifier accepted unsupported `as?` option codegen type\")",
    "crates/scoopc/src/llvm/codegen/mir_body/cast.rs:165:            panic!(\"codegen_mir_cast_asq: MIR verifier accepted invalid `as?` result type\");",
    "crates/scoopc/src/llvm/codegen/mir_body/cast.rs:205:            panic!(",
    "crates/scoopc/src/llvm/codegen/mir_body/cast.rs:211:            .unwrap_or_else(|| panic!(\"codegen_mir_runtime_type_test_is_ok: TypeStore equivalence verifier accepted unsupported runtime type target\"));",
    "crates/scoopc/src/llvm/codegen/mir_body/cast.rs:227:                panic!(",
    "crates/scoopc/src/llvm/codegen/mir_body/cast.rs:233:            panic!(",
    "crates/scoopc/src/llvm/codegen/mir_body/cast.rs:248:            _ => panic!(",
    "crates/scoopc/src/llvm/codegen/mir_body/cast.rs:332:            panic!(",
    ...
    "crates/scoopc/src/llvm/codegen/mir_body/const_pat.rs:60:                    _ => panic!(",
    "crates/scoopc/src/llvm/codegen/mir_body/const_pat.rs:142:                    panic!(\"codegen_mir_pattern_match_value: MIR verifier accepted Int pattern for non-int subject\")",
    "crates/scoopc/src/llvm/codegen/mir_body/const_pat.rs:154:                    panic!(\"codegen_mir_pattern_match_value: MIR verifier accepted Char pattern for non-int subject\")",
    "crates/scoopc/src/llvm/codegen/mir_body/const_pat.rs:165:                    panic!(",
    "crates/scoopc/src/llvm/codegen/mir_body/const_pat.rs:170:                    panic!(",
    "crates/scoopc/src/llvm/codegen/mir_body/const_pat.rs:178:                    panic!(",
    "crates/scoopc/src/llvm/codegen/mir_body/const_pat.rs:198:                    panic!(",
    "crates/scoopc/src/llvm/codegen/mir_body/const_pat.rs:212:                    .unwrap_or_else(|| panic!(\"codegen_mir_pattern_match_value: MIR verifier accepted Bool pattern for non-bool subject\"));",
    "crates/scoopc/src/llvm/codegen/mir_body/const_pat.rs:232:            panic!(",
    "crates/scoopc/src/llvm/codegen/mir_body/const_pat.rs:238:            .unwrap_or_else(|| panic!(\"codegen_mir_is_pattern_match: MIR verifier accepted unsupported pattern subject metadata type\"));",
    "crates/scoopc/src/llvm/codegen/mir_body/const_pat.rs:240:            panic!(",
    "crates/scoopc/src/llvm/codegen/mir_body/const_pat.rs:254:            panic!(",
    "crates/scoopc/src/llvm/codegen/mir_body/const_pat.rs:260:            .unwrap_or_else(|| panic!(\"codegen_mir_is_pattern_match: MIR verifier accepted unsupported runtime target type\"));",
    "crates/scoopc/src/llvm/codegen/mir_body/const_pat.rs:263:            .unwrap_or_else(|| panic!(\"codegen_mir_is_pattern_match: MIR verifier accepted non-codegen runtime target type\"));",
    "crates/scoopc/src/llvm/codegen/mir_body/const_pat.rs:265:            panic!(",
    "crates/scoopc/src/llvm/codegen/mir_body/const_pat.rs:274:                panic!(",
    "crates/scoopc/src/llvm/codegen/mir_body/const_pat.rs:280:            panic!(",
    "crates/scoopc/src/llvm/codegen/mir_body/const_pat.rs:295:            panic!(",
    "crates/scoopc/src/llvm/codegen/mir_body/const_pat.rs:300:            panic!(",
    "crates/scoopc/src/llvm/codegen/mir_body/const_pat.rs:305:            panic!(",
    "crates/scoopc/src/llvm/codegen/mir_body/const_pat.rs:320:            panic!(",
    "crates/scoopc/src/llvm/codegen/mir_body/const_pat.rs:328:                panic!(\"codegen_mir_tuple_pattern_match: MIR verifier accepted unsupported tuple pattern element type\")",
    "crates/scoopc/src/llvm/codegen/mir_body/const_pat.rs:349:            panic!(",
    "crates/scoopc/src/llvm/codegen/mir_body/const_pat.rs:354:            panic!(",
    "crates/scoopc/src/llvm/codegen/mir_body/const_pat.rs:366:                .unwrap_or_else(|| panic!(\"codegen_mir_variant_pattern_match: MIR verifier accepted unknown enum variant pattern\"));",
    "crates/scoopc/src/llvm/codegen/mir_body/const_pat.rs:378:            panic!(",
    "crates/scoopc/src/llvm/codegen/mir_body/const_pat.rs:459:                        panic!(",
    "crates/scoopc/src/llvm/codegen/mir_body/const_pat.rs:464:                        panic!(",
    "crates/scoopc/src/llvm/codegen/mir_body/const_pat.rs:469:                        panic!(\"codegen_mir_pattern_extract: MIR verifier accepted tuple extraction field drift\")",
    "crates/scoopc/src/llvm/codegen/mir_body/const_pat.rs:483:                        panic!(",
    "crates/scoopc/src/llvm/codegen/mir_body/const_pat.rs:493:                        .unwrap_or_else(|| panic!(\"codegen_mir_pattern_extract: MIR verifier accepted unknown enum variant extraction\"));",
    "crates/scoopc/src/llvm/codegen/mir_body/const_pat.rs:547:                            panic!(",
    ...
    "crates/scoopc/src/llvm/codegen/mir_body/dispatch.rs:374:            panic!(\"codegen_mir_plain_dispatch_call: MIR verifier accepted unsupported return type\")",
    "crates/scoopc/src/llvm/codegen/mir_body/dispatch.rs:406:            .unwrap_or_else(|| panic!(\"codegen_mir_plain_dispatch_call: verifier accepted missing dispatch receiver pointer\"));",
    "crates/scoopc/src/llvm/codegen/mir_body/dispatch.rs:541:                    .unwrap_or_else(|| panic!(\"selected_mir_class_ctor_from_contract: verifier accepted missing selected ctor\")),",
    "crates/scoopc/src/llvm/codegen/mir_body/dispatch.rs:545:                panic!(\"selected_mir_class_ctor_from_contract: verifier accepted unselected ctor contract\");",
    ...
    "crates/scoopc/src/llvm/codegen/mir_body/operand.rs:353:            panic!(",
    "crates/scoopc/src/llvm/codegen/mir_body/operand.rs:361:                panic!(\"mir_closure_env_capture_element_cg_tys_from_contract: MIR verifier accepted non-tuple closure env\")",
    "crates/scoopc/src/llvm/codegen/mir_body/operand.rs:364:            panic!(",
    "crates/scoopc/src/llvm/codegen/mir_body/operand.rs:386:            _ => panic!(",
    "crates/scoopc/src/llvm/codegen/mir_body/operand.rs:397:                        panic!(\"mir_closure_env_capture_element_cg_tys_from_contract: MIR verifier accepted missing closure env capture element\")",
    "crates/scoopc/src/llvm/codegen/mir_body/operand.rs:402:                panic!(",
    ...
    "crates/scoopc/src/llvm/codegen/mir_body/terminator.rs:118:                    panic!(\"bind_lir_source_params: LIR verifier accepted unsupported param type\")",
    "crates/scoopc/src/llvm/codegen/mir_body/terminator.rs:422:                        panic!(\"codegen_mir_rvalue: MIR verifier accepted closure env without codegen type\")",
    "crates/scoopc/src/llvm/codegen/mir_body/terminator.rs:602:                    panic!(\"codegen_mir_effect_neutral_rvalue: MIR verifier accepted closure env without codegen type\")",
    ...
    "crates/scoopc/src/llvm/codegen/mir_body/transport.rs:214:            panic!(",
    "crates/scoopc/src/llvm/codegen/mir_body/transport.rs:219:            panic!(\"codegen_platform_literal: sysroot contract accepted non-Platform result type\");",
    "crates/scoopc/src/llvm/codegen/mir_body/transport.rs:224:            panic!(",
    "crates/scoopc/src/llvm/codegen/mir_body/transport.rs:245:                    panic!(\"codegen_platform_literal: sysroot contract accepted unknown Platform field `{}`\", layout_field.name)",
    ...
    "crates/scoopc/src/llvm/codegen/mir_body/types.rs:724:                panic!(\"mir_member_receiver_codegen_type_id: verifier accepted member receiver TypeStore drift\")",
    ...
    "crates/scoopc/src/llvm/codegen/mir_body/value_args.rs:103:                    panic!(",
    "crates/scoopc/src/llvm/codegen/mir_body/value_args.rs:123:                    panic!(",
    ...
    "crates/scoopc/src/llvm/codegen/effect_lowered/body/main_carrier.rs:468:            panic!(",
    "crates/scoopc/src/llvm/codegen/effect_lowered/body/main_carrier.rs:478:                        panic!(",
    ...
    "crates/scoopc/src/llvm/codegen/effect_lowered/value.rs:937:            panic!(",
    "crates/scoopc/src/llvm/codegen/effect_lowered/value.rs:996:            panic!(",
    "crates/scoopc/src/llvm/codegen/effect_lowered/value.rs:1329:                panic!(",
    "crates/scoopc/src/llvm/codegen/effect_lowered/value.rs:1370:                panic!(",
    "crates/scoopc/src/llvm/codegen/effect_lowered/value.rs:1418:                    panic!(",
    "crates/scoopc/src/llvm/codegen/effect_lowered/value.rs:1538:                    panic!(",
    "crates/scoopc/src/llvm/codegen/effect_lowered/value.rs:1564:                panic!(",
    "crates/scoopc/src/llvm/codegen/effect_lowered/value.rs:1602:                panic!(",
    "crates/scoopc/src/llvm/codegen/effect_lowered/value.rs:1709:                panic!(",
    "crates/scoopc/src/llvm/codegen/effect_lowered/value.rs:2274:                panic!(",
    "crates/scoopc/src/llvm/codegen/effect_lowered/value.rs:2305:                        panic!(",
    "crates/scoopc/src/llvm/codegen/effect_lowered/value.rs:2313:                    _ => unreachable!(\"filtered by match\"),",
    "crates/scoopc/src/llvm/codegen/effect_lowered/value.rs:2338:            _ => panic!(",
    "crates/scoopc/src/llvm/codegen/effect_lowered/value.rs:2366:                panic!(",
    "crates/scoopc/src/llvm/codegen/effect_lowered/value.rs:2384:                        panic!(",
    "crates/scoopc/src/llvm/codegen/effect_lowered/value.rs:2408:                            panic!(",
    "crates/scoopc/src/llvm/codegen/effect_lowered/value.rs:2421:                _ => panic!(",
    "crates/scoopc/src/llvm/codegen/effect_lowered/value.rs:2640:                panic!(",
    "crates/scoopc/src/llvm/codegen/effect_lowered/value.rs:2925:            panic!(",
    "crates/scoopc/src/llvm/codegen/effect_lowered/value.rs:2935:                panic!(",
    "crates/scoopc/src/llvm/codegen/effect_lowered/value.rs:2959:            panic!(",
    "crates/scoopc/src/llvm/codegen/effect_lowered/value.rs:2971:                        panic!(",
    "crates/scoopc/src/llvm/codegen/effect_lowered/value.rs:2982:                panic!(",
    "crates/scoopc/src/llvm/codegen/effect_lowered/value.rs:2997:                        panic!(",
    "crates/scoopc/src/llvm/codegen/effect_lowered/value.rs:3003:                panic!(",
    "crates/scoopc/src/llvm/codegen/effect_lowered/value.rs:3024:                    panic!(",
    "crates/scoopc/src/llvm/codegen/effect_lowered/value.rs:3106:            panic!(",
    "crates/scoopc/src/llvm/codegen/effect_lowered/value.rs:3116:                panic!(",
    "crates/scoopc/src/llvm/codegen/effect_lowered/value.rs:3390:                panic!(",
    "crates/scoopc/src/llvm/codegen/effect_lowered/value.rs:3411:            _ => unreachable!(\"filtered by caller\"),",
    "crates/scoopc/src/llvm/codegen/effect_lowered/value.rs:3722:            panic!(",
    "crates/scoopc/src/llvm/codegen/effect_lowered/value.rs:3745:                        panic!(",
    "crates/scoopc/src/llvm/codegen/effect_lowered/value.rs:3793:                            panic!(",
    "crates/scoopc/src/llvm/codegen/effect_lowered/value.rs:3922:                panic!(",
    ...
    "crates/scoopc/src/llvm/codegen/main/call.rs:690:            unreachable!(",
    ...
    "crates/scoopc/src/llvm/codegen/main/context.rs:479:            .unwrap_or_else(|| panic!(\"{context}: LIR facts are missing global root `{fqn}`\"));",
    "crates/scoopc/src/llvm/codegen/main/context.rs:481:            panic!(",
    "crates/scoopc/src/llvm/codegen/main/context.rs:496:            panic!(",
    "crates/scoopc/src/llvm/codegen/main/context.rs:509:            panic!(",
    "crates/scoopc/src/llvm/codegen/main/context.rs:532:                panic!(\"source_slice_at: parser/typecheck accepted a span outside its source\")",
    "crates/scoopc/src/llvm/codegen/main/context.rs:535:            panic!(\"source_slice_at: parser/typecheck accepted an unsliceable source span\")",
    ...
    "crates/scoopc/src/llvm/codegen/main/identity.rs:473:            panic!(\"stable_closure_key_for_materialized_callable: materialized pass view accepted missing closure callable\")",
    "crates/scoopc/src/llvm/codegen/main/identity.rs:476:            panic!(\"stable_closure_key_for_materialized_callable: callable is not a closure body\")",
    "crates/scoopc/src/llvm/codegen/main/identity.rs:483:            panic!(\"stable_closure_key_for_materialized_callable: materialized closure lacks HIR owner\")",
    "crates/scoopc/src/llvm/codegen/main/identity.rs:523:            panic!(\"direct_hir_closure_callable_fqn: closure codegen requires current callable owner\")",
    ...
    "crates/scoopc/src/llvm/codegen/main/immut_value.rs:426:                panic!(",
    "crates/scoopc/src/llvm/codegen/main/immut_value.rs:446:            panic!(",
    ...
    "crates/scoopc/src/llvm/codegen/main/runtime_error.rs:209:                panic!(\"emit_raise_runtime_error_variant: verifier accepted missing RuntimeError unit variant `{variant_name}`\")",
    "crates/scoopc/src/llvm/codegen/main/runtime_error.rs:212:            panic!(",
    "crates/scoopc/src/llvm/codegen/mod.rs:945:                    panic!(",
    "crates/scoopc/src/llvm/codegen/mod.rs:955:                            panic!(",
    "crates/scoopc/src/llvm/codegen/mod.rs:966:                                panic!(",
