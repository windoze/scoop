...
const INTERNAL_BUG_SENTINEL_HITS: &[&str] = &[
    ...
    "crates/scoopc/src/llvm/codegen/main/identity.rs:355:            panic!(\"stable_closure_key_for_materialized_callable: materialized pass view accepted missing closure callable\")",
    "crates/scoopc/src/llvm/codegen/main/identity.rs:358:            panic!(\"stable_closure_key_for_materialized_callable: callable is not a closure body\")",
    "crates/scoopc/src/llvm/codegen/main/identity.rs:365:            panic!(\"stable_closure_key_for_materialized_callable: materialized closure lacks HIR owner\")",
    "crates/scoopc/src/llvm/codegen/main/identity.rs:402:            panic!(\"direct_hir_closure_callable_fqn: closure codegen requires current callable owner\")",
