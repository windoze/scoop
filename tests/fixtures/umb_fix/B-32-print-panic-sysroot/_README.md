...
`scoop test` recognizes `tests/fixtures/umb_fix/**`. Fixtures marked `IGNORE-UNTIL-FIX:B-32` or `ignore-until-fix:B-32` are skipped until the corresponding production fix lands.
