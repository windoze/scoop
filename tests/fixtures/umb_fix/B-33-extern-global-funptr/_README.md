...
`scoop test` recognizes `tests/fixtures/umb_fix/**`. Fixtures marked `IGNORE-UNTIL-FIX:B-33` or `ignore-until-fix:B-33` are skipped until the corresponding production fix lands.
